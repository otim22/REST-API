...
process.env.DB_URI = "mongodb://cloudfan:22cloudfan22@ds155492.mlab.com:55492/pearlshub"
process.env.DB_USER = "cloudfan"
process.env.DB_PASSWORD = "22cloudfan22"
...
db.select(selectCriteria, function(err, data){
    if(err){
        console.log("Failed to get vacations : %s", data);
        console.log(err);
    } else {
